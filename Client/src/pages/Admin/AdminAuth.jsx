    ...
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          ...
          {/* Keep Clerk modal UI but trigger via API to avoid DOM prop warnings */}
          <div className="space-y-4">
            <button
              type="button"
              onClick={() => openSignIn({ mode: "modal", afterSignInUrl: "/admin/dashboard" })}
            ...
            <button
              type="button"
              onClick={() => openSignUp({ mode: "modal", afterSignUpUrl: "/admin/dashboard" })}
