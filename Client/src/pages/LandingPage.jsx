...
const LandingPage = () => {
  useEffect(() => {
    // Add any landing page animations or effects here if needed
  }, []);
      ...
      <div className="bg-gray-900 rounded-2xl shadow-xl p-4 md:p-8 lg:p-12 bg-gradient-to-br from-gray-900 to-gray-800 animate-fadeIn">
        ...
        <header className="flex justify-between items-center mb-10">
          ...
          <nav className="flex space-x-4 md:space-x-8 text-gray-400">
            ...
            <Link to="/admin" className="px-4 py-2 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 active:scale-95 active:shadow-inner transition-transform">Admin</Link>
            <Link to="/ocr" className="px-4 py-2 bg-green-600 text-white rounded-full font-semibold hover:bg-green-700 active:scale-95 active:shadow-inner transition-transform">Test OCR</Link>
          </nav>
        </header>
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between mb-16">
          <div className="lg:w-1/2 mb-8 lg:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white">HEALTH HUB</h1>
            <p className="mt-4 text-lg text-gray-300">Your one-stop solution for healthcare appointments, records, and insights.</p>
            <button className="mt-6 px-6 py-3 bg-blue-500 text-white rounded-full font-semibold shadow-lg hover:bg-blue-600 active:scale-95 active:shadow-inner transition-transform">LEARN MORE</button>
          </div>
          <div className="lg:w-1/2">
            <img src="https://placehold.co/800x600/1f2937/d1d5db?text=Medical+Professionals" alt="Medical professionals smiling" className="rounded-2xl w-full h-auto" />
          </div>
        </section>

        {/* Features Section */}
        <section className="mb-16 text-center">
          <h2 className="text-3xl font-bold text-white mb-8">Empowering Your Health Journey</h2>
          <div className="flex flex-col md:flex-row justify-around items-center space-y-8 md:space-y-0 md:space-x-8 text-gray-400">
            <div className="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-blue-400 hover:animate-bounce transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="7" width="20" height="15" rx="2" ry="2" />
                <polyline points="17 2 12 7 7 2" />
              </svg>
              <p className="text-sm font-semibold mt-2">Seamless Appointments <br />& Records</p>
            </div>
            <div className="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-blue-400 hover:animate-bounce transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="text-sm font-semibold mt-2">Personalized <br />Insights</p>
            </div>
            <div className="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-blue-400 hover:animate-bounce transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="text-sm font-semibold mt-2">Secure Data <br />& Privacy</p>
            </div>
          </div>
        </section>
